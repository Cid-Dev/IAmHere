...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IAmHere.GPSServiceConnection, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GPSServiceConnection.class, __md_methods);
	}
	...
	public GPSServiceConnection ()
	{
		...
		if (getClass () == GPSServiceConnection.class)
			mono.android.TypeManager.Activate ("IAmHere.GPSServiceConnection, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public GPSServiceConnection (md524650ccf4e7638072a622910c4fce5f8.GPSServiceBinder p0)
	{
		super ();
		if (getClass () == GPSServiceConnection.class)
			mono.android.TypeManager.Activate ("IAmHere.GPSServiceConnection, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "IAmHere.GPSServiceBinder, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
