...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IAmHere.GPSService, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", GPSService.class, __md_methods);
	}
	...
	public GPSService ()
	{
		...
		if (getClass () == GPSService.class)
			mono.android.TypeManager.Activate ("IAmHere.GPSService, IAmHere, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
